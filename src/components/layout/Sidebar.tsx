...
export const Sidebar: React.FC = () => {
  ...
  const menuItems = [
    ...
    { icon: Table, label: 'Tables', path: '/tables', modes: [BusinessMode.SIT_DOWN, BusinessMode.CHOP_BAR] },
    { icon: ShoppingCart, label: 'POS', path: '/pos', modes: [BusinessMode.FAST_FOOD, BusinessMode.SIT_DOWN, BusinessMode.CHOP_BAR] },
    { icon: ChefHat, label: 'Kitchen', path: '/kitchen', modes: 'all' },
    { icon: Calendar, label: 'Reservations', path: '/reservations', modes: [BusinessMode.SIT_DOWN, BusinessMode.CATERING] },
    ...
    { icon: Users, label: 'Staff', path: '/staff', modes: 'all' },
  ...
  return (
    <div className="w-64 bg-primary text-white h-screen flex flex-col">
      <div className="p-6">
        <h1 className="text-2xl font-bold">ChopCore</h1>
